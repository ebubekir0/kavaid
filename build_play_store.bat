...
copy build\app\outputs\bundle\release\app-release.aab kavaid-v3.2.20-build3220-play-store.aab
...
echo ===================================================
echo.
echo AAB dosyasi: kavaid-v3.2.20-build3220-play-store.aab
echo Surum: 3.2.20 (Build 3220)
echo.
echo Ozellikler:
