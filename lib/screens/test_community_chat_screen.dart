...
/// Test Topluluk Ekranı
/// Sadece kurucu (ebubekir@gmail.com) ve test kullanıcıları için
class TestCommunityChatScreen extends StatefulWidget {
  final double bottomPadding;
  final double topPadding;

  const TestCommunityChatScreen({
    super.key,
  ...
  @override
  State<TestCommunityChatScreen> createState() => _TestCommunityChatScreenState();
}

class _TestCommunityChatScreenState extends State<TestCommunityChatScreen> with WidgetsBindingObserver, AutomaticKeepAliveClientMixin {
  @override
  bool get wantKeepAlive => false; // PERFORMANCE: Sadece aktif sekmede çalışsın
  final TestCommunityChatService _chatService = TestCommunityChatService();
