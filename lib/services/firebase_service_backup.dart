...
// 1c. ANLAM İÇİNDE GEÇİYOR - "katıl" aradığında "iştirak, katılım" olan kelimeler
final aMeaningContains = _hasMeaningContains(aAnlam, lowerTurkishQuery);
final bMeaningContains = _hasMeaningContains(bAnlam, lowerTurkishQuery);
  
if (aMeaningContains && !bMeaningContains) return -1;
if (bMeaningContains && !aMeaningContains) return 1;
